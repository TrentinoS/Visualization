...
fig = go.Figure()
fig.add_trace(go.Scatter(x =df['Horsepower'] , y=df['Weight'], mode = 'markers'))
fig.show()

#add a color variable to the dataframe
df["Color"] = "#2471A3"
...
fig.update_xaxes(title = "Horsepower (hp)", tickformat = ",", linecolor = "#909497")
fig.update_yaxes(title = "Weight (kgs)", linecolor = "#909497") 
...
fig.add_annotation(text = "Author: Milan Singh",
                    xref = "paper",
                    yref = "paper",
                    x = 1.005,
                    y = -0.145,
